package com.dotplays.moneymanager;

import android.os.Bundle;

import com.dotplays.moneymanager.fragment.ChiFragment;
import com.dotplays.moneymanager.fragment.ThuFragment;
import com.dotplays.moneymanager.sqlite.ThuChiSqlite;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_thu) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.myContainer, thuFragment)
                    .commit();
